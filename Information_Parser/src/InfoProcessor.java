...
public class InfoProcessor {
	...
	public String getCourseName() {
		...
		String courseID = this.getNextStringStartsWith("Course:");
		return courseID;
	}
	...
	public int getCourseId() {
		...
		String courseID = this.getNextStringStartsWith("CourseID:");
	...
	public int getStudentId() {
		...
		String studentID = this.getNextStringStartsWith("StudentID:");
