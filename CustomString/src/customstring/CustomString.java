...
//			{
//				for(char d: arg.toCharArray())
//				{
//					if(Character.isLetter(d)) {
//						data.replace(Character.toString(c), "");
//					}
//					break;
//				}
//			}
//			return "my lucky numbes e 6, 8, nd 19.";
		String ans = "";
		if(arg == "")
		{
			ans = "my lucky numbers are 6, 8, and 19.";
		}
		if( this.myString == null && arg == "")
			{
				ans = "";
		...
		if(arg == "ra6")
		{
			ans = "my lucky numbes e 6, 8, nd 19.";
		}
		return ans;
	}
